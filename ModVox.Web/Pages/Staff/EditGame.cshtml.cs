...
public sealed class EditGameModel : PageModel
{
    ...
    public EditGameModel(IAccountAuthorizationService authorizationService, IPageIncludeService pageIncludeService)
    {
