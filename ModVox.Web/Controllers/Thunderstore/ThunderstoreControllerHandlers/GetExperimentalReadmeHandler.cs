...
public sealed class GetExperimentalReadmeHandler
{
    private readonly IModRepository _modRepository;
    private readonly IModReleaseRepository _releaseRepository;

    public GetExperimentalReadmeHandler(IModRepository modRepository, IModReleaseRepository releaseRepository)
    {
...
public sealed record GetExperimentalReadmeResponse(ThunderstoreMarkdownDto Readme);
