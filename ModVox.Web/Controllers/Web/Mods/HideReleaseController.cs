...
/// <summary>
/// Hides a release. Allowed for: moderators, admins, and the mod's maintainer.
/// </summary>
public sealed class HideReleaseEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/v1/releases/{releaseId:guid}/hide", HandleAsync);
    }
